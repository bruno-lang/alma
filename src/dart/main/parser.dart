...
class Parser {
  ...
  static ParseTree parse0(List<int> input, Rule start) {
    ParseTree tree = new ParseTree.empty();
    int t = 0;
    try {
  ...
  static int parse(Rule rule, List<int> input, int position, ParseTree tree) {
    switch (rule.type) {
